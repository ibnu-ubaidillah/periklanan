                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <select name="id_pembayaran" id="nama" class="form-control">
                                    ...
                                    <?php
                                    $id = $this->input->post('id_pembayaran') ? $this->input->post('id_pembayaran') : $row->id_pembayaran;
                                    foreach ($pembayaran as $data) { ?>
                                        <option value="<?= $data->id_pembayaran ?>" <?= $id == $data->id_pembayaran ? "selected" : null ?>><?= $data->kode_pembayaran ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="tgl">Tanggal</label>
                                <input type="date" name="tanggal_tayang" id="tgl" class="form-control" value="<?= $this->input->post('tanggal_tayang') ?? $row->tanggal_tayang ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class=" form-group">
                                ...
                                <textarea name="keterangan" cols="5" rows="5" class="form-control"><?= $this->input->post('keterangan') ?? $row->keterangan ?></textarea>
